  ...
  let sorter = [
    //{ index: 0, condition: true, dom: <PanelGuides state={state}/> },
	  ...
	  //{ index: 2, condition: true, dom: <PanelColour state={state} /> },
		{ index: 3, condition: true, dom: <PanelRefresh state={state} />},
    { index: 4, condition: true, dom: <PanelLayers state={state} /> },
    { index: 5, condition: true, dom: <PanelLayerElements mode={state.mode} layers={state.scene.layers} selectedLayer={state.scene.selectedLayer} /> },
    { index: 6, condition: true, dom: <PanelGroups mode={state.mode} groups={state.scene.groups} layers={state.scene.layers} /> },
    { index: 7, condition: !multiselected, dom: <PanelElementEditor state={state} /> },
    //{ index: 8, condition: multiselected, dom: <PanelMultiElementsEditor state={state} /> },
    { index: 9, condition: !!selectedGroup, dom: <PanelGroupEditor state={state} groupID={selectedGroup ? selectedGroup[0] : null} /> }
  ];
