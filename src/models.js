...
export class Scene extends Record({
  ...
  constructor(json = {}) {
    ...
    super({
      ...
      globalTexture: json.globalTexture ? fromJS(json.globalTexture) : "", //Created for global texture.
      worktopTexture: json.worktopTexture ? fromJS(json.worktopTexture) : "", //Created for worktop texture.
