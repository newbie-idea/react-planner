...
import {sceneValues, dbu1150GableArrays} from '../../utils/mtl-exports';

let globalTexture;
let worktopTexture;
let dbu1150GableLeftValue;
let dbu1150GableRightValue;
let kickboardValue;
let hingeNumber;
...
let cachedJSONDoubleBaseUnit1150 = null;

export default {
  name: 'Double Base Unit 1150',
  prototype: 'items',

  info: {
    title: 'DBU 1150',
    tag: ['double', 'base'],
    description: 'Double Base Unit 1150',
    image: require('../../images/DBU-1150.png')
  },
  ...
  render2D: function (element, layer, scene) {
    ...
    dbu1150GableLeftValue = element.properties.get('gableLeft');
    dbu1150GableRightValue = element.properties.get('gableRight');
    dbu1150GableArrays(dbu1150GableLeftValue, dbu1150GableRightValue);
    ...
    if (true == dbu1150GableLeftValue) {
	    lineStyleB = { stroke: '#000', strokeWidth: '1px' };
    }
    
    if (true == dbu1150GableRightValue) {
  ...
  render3D: function (element, layer, scene) {
    ...
    if (cachedJSONDoubleBaseUnit1150) {
      let loader = new ObjectLoader();
      let object = loader.parse(cachedJSONDoubleBaseUnit1150);
      return Promise.resolve(onLoadItem(object));
    }

    return loadObjWithMaterial(mtl, obj, path.dirname(img1) + '/')
      .then(object => {
        cachedJSONDoubleBaseUnit1150 = object.toJSON();
        let loader = new ObjectLoader();
        return onLoadItem(loader.parse(cachedJSONDoubleBaseUnit1150))
      });
