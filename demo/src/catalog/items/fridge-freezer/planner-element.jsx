...
let cachedJSONFridgeFreezer = null;
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if (cachedJSONFridgeFreezer) {
      let loader = new ObjectLoader();
      let object = loader.parse(cachedJSONFridgeFreezer);
      return Promise.resolve(onLoadItem(object));
    }

    return loadObjWithMaterial(mtl, obj, path.dirname(img1) + '/')
      .then(object => {
        cachedJSONFridgeFreezer = object.toJSON();
        let loader = new ObjectLoader();
        return onLoadItem(loader.parse(cachedJSONFridgeFreezer))
      });
