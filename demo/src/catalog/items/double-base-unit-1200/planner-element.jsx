...
import {sceneValues, dbu1200GableArrays} from '../../utils/mtl-exports';

let globalTexture;
let worktopTexture;
let dbu1200GableLeftValue;
let dbu1200GableRightValue;
let kickboardValue;
let hingeNumber;
...
let cachedJSONDoubleBaseUnit1200 = null;

export default {
  name: 'Double Base Unit 1200',
  prototype: 'items',

  info: {
    title: 'DBU 1200',
    tag: ['double', 'base'],
    description: 'Double Base Unit 1200',
    image: require('../../images/DBU-1200.png')
  },
  ...
  render2D: function (element, layer, scene) {
    ...
    dbu1200GableLeftValue = element.properties.get('gableLeft');
    dbu1200GableRightValue = element.properties.get('gableRight');
    dbu1200GableArrays(dbu1200GableLeftValue, dbu1200GableRightValue);
    ...
    if (true == dbu1200GableLeftValue) {
	    lineStyleB = { stroke: '#000', strokeWidth: '1px' };
    }
    
    if (true == dbu1200GableRightValue) {
  ...
  render3D: function (element, layer, scene) {
    ...
    if (cachedJSONDoubleBaseUnit1200) {
      let loader = new ObjectLoader();
      let object = loader.parse(cachedJSONDoubleBaseUnit1200);
      return Promise.resolve(onLoadItem(object));
    }

    return loadObjWithMaterial(mtl, obj, path.dirname(img1) + '/')
      .then(object => {
        cachedJSONDoubleBaseUnit1200 = object.toJSON();
        let loader = new ObjectLoader();
        return onLoadItem(loader.parse(cachedJSONDoubleBaseUnit1200))
      });
