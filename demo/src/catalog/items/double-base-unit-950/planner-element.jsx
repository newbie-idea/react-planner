...
import {sceneValues, dbu950GableArrays} from '../../utils/mtl-exports';

let globalTexture;
let worktopTexture;
let dbu950GableLeftValue;
let dbu950GableRightValue;
let kickboardValue;
let hingeNumber;
...
let cachedJSONDoubleBaseUnit950 = null;

export default {
  name: 'Double Base Unit 950',
  prototype: 'items',

  info: {
    title: 'DBU 950',
    tag: ['double', 'base'],
    description: 'Double Base Unit 950',
    image: require('../../images/DBU-950.png')
  },
  ...
  render2D: function (element, layer, scene) {
    ...
    dbu950GableLeftValue = element.properties.get('gableLeft');
    dbu950GableRightValue = element.properties.get('gableRight');
    dbu950GableArrays(dbu950GableLeftValue, dbu950GableRightValue);
    ...
    if (true == dbu950GableLeftValue) {
	    lineStyleB = { stroke: '#000', strokeWidth: '1px' };
    }
    
    if (true == dbu950GableRightValue) {
