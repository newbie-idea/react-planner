...
import {sceneValues, becbu1050GableArrays} from '../../utils/mtl-exports';

let globalTexture;
let worktopTexture;
let becbu1050GableLeftValue;
let becbu1050GableRightValue;
let kickboardValue;
let hingeNumber;
let doorNumber;

const mtl = require('./double-base-unit-1050.mtl');
const obj = require('./double-base-unit-1050.obj');
...
let cachedJSONBlankEndCornerBaseUnit1050 = null;

export default {
  name: 'Blank End Corner Base Unit 1050',
  prototype: 'items',

  info: {
    title: 'BECBU 1050',
    tag: ['blank end', 'base'],
    description: 'Blank End Corner Base Unit 1050',
    image: require('../../images/BECBU-1050.png')
  },
  ...
  render2D: function (element, layer, scene) {
    ...
    becbu1050GableLeftValue = element.properties.get('gableLeft');
    becbu1050GableRightValue = element.properties.get('gableRight');
    becbu1050GableArrays(becbu1050GableLeftValue, becbu1050GableRightValue);
    ...
    if (true == becbu1050GableLeftValue) {
	    lineStyleB = { stroke: '#000', strokeWidth: '1px' };
    }
    
    if (true == becbu1050GableRightValue) {
  ...
  render3D: function (element, layer, scene) {
    ...
    if (cachedJSONBlankEndCornerBaseUnit1050) {
      let loader = new ObjectLoader();
      let object = loader.parse(cachedJSONBlankEndCornerBaseUnit1050);
      return Promise.resolve(onLoadItem(object));
    }

    return loadObjWithMaterial(mtl, obj, path.dirname(img1) + '/')
      .then(object => {
        cachedJSONBlankEndCornerBaseUnit1050 = object.toJSON();
        let loader = new ObjectLoader();
        return onLoadItem(loader.parse(cachedJSONBlankEndCornerBaseUnit1050))
      });
