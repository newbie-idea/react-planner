...
const mtl = require('./fridge-freezer.mtl');
const obj = require('./fridge-freezer.obj');
...
let cachedJSONAmericanFridgeFreezer = null;
...
export default {
  ...
  info: {
    title: 'AFF',
    tag: ['double', 'base'],
    description: 'American Fridge Freezer',
    image: require('../../images/AFF.png')
  },
  ...
  render3D: function (element, layer, scene) {
    ...
    if (cachedJSONAmericanFridgeFreezer) {
      let loader = new ObjectLoader();
      let object = loader.parse(cachedJSONAmericanFridgeFreezer);
      return Promise.resolve(onLoadItem(object));
    }

    return loadObjWithMaterial(mtl, obj, path.dirname(img1) + '/')
      .then(object => {
        cachedJSONAmericanFridgeFreezer = object.toJSON();
        let loader = new ObjectLoader();
        return onLoadItem(loader.parse(cachedJSONAmericanFridgeFreezer))
      });
