...
let cachedJSONTumbleDryer = null;
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if (cachedJSONTumbleDryer) {
      let loader = new ObjectLoader();
      let object = loader.parse(cachedJSONTumbleDryer);
      return Promise.resolve(onLoadItem(object));
    }

    return loadObjWithMaterial(mtl, obj, path.dirname(img1) + '/')
      .then(object => {
        cachedJSONTumbleDryer = object.toJSON();
        let loader = new ObjectLoader();
        return onLoadItem(loader.parse(cachedJSONTumbleDryer))
      });
