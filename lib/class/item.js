...
var _footerbar = require('../components/footerbar/footerbar');
...
var Item = function () {
  ...
  _createClass(Item, null, [{
    ...
    value: function updateDraggingItem(state, x, y) {
      ...
      } else if (true == _footerbar.snapX50) {
      ...
      } else if (true == _footerbar.snapY50) {
      ...
      } else if (true == _footerbar.snapY1) {
