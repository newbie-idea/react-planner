...
var _panelRefresh = require('./panel-refresh');

var _panelRefresh2 = _interopRequireDefault(_panelRefresh);

var _panelWorktops = require('./panel-worktops');

var _panelWorktops2 = _interopRequireDefault(_panelWorktops);

var _panelColour = require('./panel-colour');

var _panelColour2 = _interopRequireDefault(_panelColour);
...
function Sidebar(_ref) {
  ...
  //{ index: 1, condition: true, dom: <PanelWorktops state={state} /> },
  //{ index: 2, condition: true, dom: <PanelColour state={state} /> },
  { index: 3, condition: true, dom: _react2.default.createElement(_panelRefresh2.default, { state: state }) }, { index: 4, condition: true, dom: _react2.default.createElement(_panelLayers2.default, { state: state }) }, { index: 5, condition: true, dom: _react2.default.createElement(_panelLayerElements2.default, { mode: state.mode, layers: state.scene.layers, selectedLayer: state.scene.selectedLayer }) }, { index: 6, condition: true, dom: _react2.default.createElement(_panelGroups2.default, { mode: state.mode, groups: state.scene.groups, layers: state.scene.layers }) }, { index: 7, condition: !multiselected, dom: _react2.default.createElement(_panelElementEditor2.default, { state: state }) },
  //{ index: 8, condition: multiselected, dom: <PanelMultiElementsEditor state={state} /> },
  { index: 9, condition: !!selectedGroup, dom: _react2.default.createElement(_panelGroupEditor2.default, { state: state, groupID: selectedGroup ? selectedGroup[0] : null }) }];
