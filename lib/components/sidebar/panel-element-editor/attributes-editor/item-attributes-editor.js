...
function ItemAttributesEditor(_ref, _ref2) {
  ...
  var trueX = renderedX / 2 * 10;
  var trueY = renderedY / 2 * 10;
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_formNumberInput2.default, _extends({
            ...
            , onChange: function onChange(event) {
              return onUpdate('x', event.target.value / 10 * 2);
            } //Double value to correct scale.
            , style: inputStyle,
            state: state,
            precision: 2
          }, rest))
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_formNumberInput2.default, _extends({
            ...
            , onChange: function onChange(event) {
              return onUpdate('y', event.target.value / 10 * 2);
            } //Double value to correct scale.
            , style: inputStyle,
            state: state,
            precision: 2
