...
//Create three layers by default.


var DefaultLayers = exports.DefaultLayers = new _immutable.Map({
  'layer-1': new Layer({ id: 'layer-1', name: 'base units' }),
  'layer-2': new Layer({ id: 'layer-2', name: 'worktops' }),
  'layer-3': new Layer({ id: 'layer-3', name: 'wall units' })
});
...
var Scene = exports.Scene = function (_Record10) {
  ...
  function Scene() {
    ...
    return _possibleConstructorReturn(this, (Scene.__proto__ || Object.getPrototypeOf(Scene)).call(this, _extends({}, json, {
      ...
      globalTexture: json.globalTexture ? (0, _immutable.fromJS)(json.globalTexture) : "", //Created for global texture.
      worktopTexture: json.worktopTexture ? (0, _immutable.fromJS)(json.worktopTexture) : "", //Created for worktop texture.
  ...
  globalTexture: "", //Created for global texture.
  worktopTexture: "", //Created for worktop texture.
